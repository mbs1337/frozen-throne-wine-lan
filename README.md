...
[![Built for](https://img.shields.io/badge/BUILT%20FOR-Arch%20Linux-1793D1?style=flat-square&logo=archlinux&logoColor=white)](https://archlinux.org/)
...
| File | Purpose |
|------|---------|
| `setup-linux.sh` | First-time setup (Arch / pacman) |
| `warcraft3-ft` | Launcher |
...
2. Read `INSTALL.md`
3. On Arch: `./setup-linux.sh` then `./warcraft3-ft`
